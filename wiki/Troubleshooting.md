...
![Basic Status Check](images/device-status-check.png)

*SmartThings device status indicators and health monitoring*

![Grill Error Display](images/error_screen.jpg)

*Example of grill display showing error condition that triggers panic state*
...
2. **Check network compatibility / IP**:
   ...
   ![Network Connectivity Test](images/network-connectivity-testing.png)
   
   *Using a ping command to test network connectivity to the grill.*
...
![Network Diagnostics Process](images/network-diagnostics.png)

*Pit Boss Network troubleshooting info*
...
*WiFi signal testing and improvement steps for grill connectivity*
...
![Temperature Testing Setup](images/temperature-testing.jpg)

*Proper thermometer comparison testing for calibration*
