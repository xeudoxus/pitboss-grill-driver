...
![Device Preferences Main Screen](images/device-preferences.png)

*Main device preferences screen showing all configuration options*
...
![IP Address Configuration](images/ip-address-config.jpg)

*IP address setting and network discovery options*
...
![Temperature Calibration Settings](images/temperature-calibration.png)

*Temperature offset configuration screen for all sensors*

![Ice Water Test](images/temperature-testing.jpg)

*Performing an ice water test to calibrate a temperature probe.*
...
- **Google Home**: *"what's probe 1 temperature?"* queries
...
- **Google Home**: *"what's probe 3 temperature?"* queries
...
- **Google Home**: *"turn on grill prime"* voice control
...
- **Google Home**: *"is the grill at temp?"* status checks
...
- **Google Home**: *"check grill status"* for error information
- **SmartThings**: Error-based automation triggers
- **Recommended**: Enable for proactive monitoring

![Virtual Device Configuration Options](images/virtual-device-options.jpg)

*Virtual device enable/disable settings in preferences*
...
| :---: | :---: |
| ![Main Virtual Device](images/virtual-grill-main.jpg) | ![Simplified Interface](images/main-virtual-simple-screen.jpg) |

*Comparison of the main virtual device and its simplified interface.*
...
*Note: Values are approximated from PB1285KC testing. Other models may vary.*
...
![Debug Logging Configuration](images/debug-logging.png)

*Debug logging settings and SmartThings log viewer*
...
|----------|------------|---------|
| **Main Grill Screen** | ![Pit Boss App Main Screen](images/pb-app-main-grill-screen.png) | Monitor grill status and basic controls |
| **Add New Grill** | ![Add Grill Interface](images/pb-app-add-grill.png) | Adding additional grills to your account |
| **Edit Grill Settings** | ![Edit Grill Settings](images/pb-app-edit-grill.png) | Modify grill name and configuration |

### Network Management

| Function | Screenshot | Purpose |
|----------|------------|---------|
| **WiFi Network Change** | ![Change WiFi Network](images/pb-app-change-wifi.png) | Update grill's WiFi connection |
| **Password Management** | ![Password Change](images/pb-app-password-change.png) | Modify grill access password |

*Official Pit Boss app interfaces for grill management and network configuration*
