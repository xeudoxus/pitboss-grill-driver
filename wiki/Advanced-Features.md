...
![Driver Architecture Diagram](images/virtual-device-architecture.png)

*ESP32 hardware analysis during development - though the driver implementation ultimately relies on publicly accessible web interface files*
...
- **Base Keys**: Hardcoded cryptographic constants reverse-engineered from firmware
...
![Virtual Device Architecture](images/virtual-device-architecture.png)

*Hub-spoke virtual device diagram showing data flow*
...
*The ESP32 module responsible for WiFi communication in many Pit Boss grills.*

![ESP32 Connection Details](images/esp32-connection.jpg)

*ESP32 module connection and wiring details for advanced troubleshooting*

### 4-Probe System
The driver supports grills with up to four temperature probes.

![4-Probe Meat Probe](images/4_probe.jpg)

*An example of a 4-probe system used for monitoring multiple food items.*
...
| :---: | :---: |
| ![4-Probe System](images/probe-4-f.jpg) | ![Probe with Disconnected State](images/probe-4-w-dc.jpg) |

*Examples of the 4-probe system and how a disconnected probe appears.*