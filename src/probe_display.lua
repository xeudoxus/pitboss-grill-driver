...
local FOUR_PROBE_SPACING_PATTERNS = {
  ...
  ["2-2-2-2"] = {REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE, REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE, REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE},
  ["3-2-2-2"] = {UNICODE_SPACE .. REGULAR_SPACE, REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE, REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE},
  ["2-3-2-2"] = {REGULAR_SPACE .. UNICODE_SPACE, UNICODE_SPACE .. REGULAR_SPACE, REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE},
  ["2-2-3-2"] = {REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE, REGULAR_SPACE .. UNICODE_SPACE, UNICODE_SPACE .. REGULAR_SPACE},
  ["2-2-2-3"] = {REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE, REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE, REGULAR_SPACE .. UNICODE_SPACE},
...
local PROBE_LABELS = {
  ...
  FOUR_PROBE = REGULAR_SPACE .. UNICODE_SPACE .. REGULAR_SPACE .. 'ᴘ¹' ..
               REGULAR_SPACE .. uspace(3) .. REGULAR_SPACE .. 'ᴘ²' ..
               REGULAR_SPACE .. uspace(3) .. REGULAR_SPACE .. 'ᴘ³' ..
               REGULAR_SPACE .. uspace(3) .. REGULAR_SPACE .. 'ᴘ⁴'
}
...
function M.generate_two_probe_text(temp1, temp2, is_fahrenheit)
  ...
  local before_temp1 = (temp1_digits == 2) 
    and (uspace(4) .. REGULAR_SPACE)  -- 2-digit case
...
function M.generate_probe_text(probe_temps, is_fahrenheit)
  ...
  if use_four_probe then
    ...
    return M.generate_two_probe_text(
      probe_temps[1] or 0, 
      probe_temps[2] or 0, 
      is_fahrenheit
    )
