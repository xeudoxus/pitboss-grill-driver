--[[
  ...
  - grillTemp: Enhanced temperature display and target setting with precision control
...
-- Enhanced temperature control and display capability
...
local function validate_capabilities()
  local required_capabilities = {
    "grillTemp", "temperatureProbes", "pelletStatus", 
    "lightControl", "primeControl", "temperatureUnit", "grillStatus"
  }
