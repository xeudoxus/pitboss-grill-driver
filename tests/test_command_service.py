...
"""
    ...
    def test_temperature_command_off_and_on(self):
        ...
        ok_off = cs["send_temperature_command"](dev_off, dev_off["driver"], test_temp)
        self._refresh_recorder()
        ...
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        ok_on = cs["send_temperature_command"](dev_on, dev_on["driver"], test_temp)
        self._refresh_recorder()
    ...
    def test_temperature_snapping_and_conversion(self):
        ...
        ok_extreme = cs["send_temperature_command"](
            dev_on, dev_on["driver"], extreme_temp
        )
        self._refresh_recorder()
        ...
        ok_celsius = cs["send_temperature_command"](
            dev_on, dev_on["driver"], celsius_approved
        )
        self._refresh_recorder()
    ...
    def test_power_command(self):
        ...
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result = cs.send_power_command(dev_on, dev_on["driver"], "off")
    ...
    def test_light_command(self):
        ...
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result_off = cs["send_light_command"](dev_off, dev_off["driver"], "ON")
        self._refresh_recorder()
        self.assertFalse(result_off)
        self.assertEqual(len(self.sent), 0)
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result_on = cs["send_light_command"](dev_on, dev_on["driver"], "ON")
        self._refresh_recorder()
    ...
    def test_prime_command(self):
        ...
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result_off = cs["send_prime_command"](dev_off, dev_off["driver"], "ON")
        self._refresh_recorder()
        self.assertFalse(result_off)
        self.assertEqual(len(self.sent), 0)
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result_on = cs["send_prime_command"](dev_on, dev_on["driver"], "ON")
        self._refresh_recorder()
        self.assertTrue(result_on)
        self.assertEqual(len(self.sent), 1)
    ...
    def test_prime_off_command(self):
        ...
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result_off = cs["send_prime_command"](dev_on, dev_on["driver"], "OFF")
        self._refresh_recorder()
    ...
    def test_network_failure_handling(self):
        ...
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result = cs["send_temperature_command"](dev_on, dev_on["driver"], 225)
        self._refresh_recorder()
        ...
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result = cs["send_light_command"](dev_on, dev_on["driver"], "ON")
        self._refresh_recorder()
    ...
    def test_unit_command(self):
        ...
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result_off = cs["send_unit_command"](dev_off, dev_off["driver"], "C")
        self._refresh_recorder()
        self.assertFalse(result_off)
        self.assertEqual(len(self.sent), 0)
        self.recorder.clear_sent(self.recorder)
        self._refresh_recorder()
        result_on = cs["send_unit_command"](dev_on, dev_on["driver"], "C")
        self._refresh_recorder()
        self.assertTrue(result_on)
        self.assertEqual(len(self.sent), 1)
    ...
    def test_light_control_commands(self):
        ...
        # Test light on
        result = self.command_service.set_light(dev, "on", mock_driver)
        self._refresh_recorder()
        self.assertTrue(result, "should turn light on")

        # Test light off
        result = self.command_service.set_light(dev, "off", mock_driver)
        self._refresh_recorder()
    ...
    def test_prime_control_commands(self):
        ...
        # Test prime on
        result = self.command_service.set_prime(dev, "on", mock_driver)
        self._refresh_recorder()
        self.assertTrue(result, "should turn prime on")

        # Test prime off
        result = self.command_service.set_prime(dev, "off", mock_driver)
        self._refresh_recorder()
    ...
    def test_command_validation(self):
        ...
        result = self.command_service.set_light(dev, "invalid", mock_driver)
        self.assertFalse(result, "should reject invalid light command")

        # Test invalid prime command
        result = self.command_service.set_prime(dev, "invalid", mock_driver)
    ...
    def test_command_service_error_handling(self):
        ...
        result = self.command_service.send_light_command(dev, mock_driver, "ON")
    ...
    def test_command_service_device_state_validation(self):
        ...
        # Test with grill off
        dev_off = self.make_device("off")
        result = self.command_service.set_light(dev_off, "on", mock_driver)
        self.assertFalse(result, "should reject command when grill is off")

        # Test with grill on
        dev_on = self.make_device("on")
        result = self.command_service.set_light(dev_on, "on", mock_driver)
    ...
    def test_command_service_parameter_validation(self):
        ...
        try:
            result = self.command_service.set_light(dev, None, mock_driver)
        ...
        result = self.command_service.set_light(dev, "", mock_driver)
