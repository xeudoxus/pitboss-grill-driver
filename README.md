...
| `-DetailedOutput`     | `-v`                                    | Show detailed output for placeholder/capability file changes                                  |
...
- **Amazon Alexa**: _"Alexa, turn on the grill light"_, _"Alexa, turn off the grill"_ (tested - see [Alexa Setup Guide](wiki/Alexa-Setup.md))
