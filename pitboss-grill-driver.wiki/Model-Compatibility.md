...
<a href="images/pb1285kc-control-panel.png"><img src="images/pb1285kc-control-panel.png" alt="PB1285KC Control Panel Reference" width="600"></a>

_PB1285KC control panel showing WiFi indicator and display layout (click to enlarge)_

<a href="images/cp-info.jpg"><img src="images/cp-info.jpg" alt="Alternative Control Panel Layout" width="600"></a>

_Additional control panel configuration found on similar Pit Boss models (click to enlarge)_
...
_This section will expand as users report successful testing with other models._
...
<a href="images/model-series-comparison.png"><img src="images/model-series-comparison.png" alt="Pit Boss Grill Series Comparison" width="600"></a>

_Comparison of different Pit Boss grill series (click to enlarge)_
...
4. **Expected JSON response** (if compatible):
   ...
   <a href="images/network-connectivity-testing.png"><img src="images/network-connectivity-testing.png" alt="Network Connectivity Testing" width="600"></a>

   _Network testing commands and results for grill compatibility verification (click to enlarge)_
...
<a href="images/model-number-locations.png"><img src="images/model-number-locations.png" alt="Model Number Location Examples" width="500"></a>

_Example locations for your grill's model number sticker (click to enlarge)._
...
_Last updated: August 2025 - This table will be updated as users report results_
